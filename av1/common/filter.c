...
//	{ 0, 0,   0, 128,  0,   0,   0, 0 },{ 0, 0, -4,  124,   8,   -2,   0, 0 },
//	{ 0, 0,  -6, 120, 18,  -4,   0, 0 },{ 0, 0, -8,  114,  26,   -6,   0, 0 },
//	{ 0, 0, -10, 108, 36,  -8,   0, 0 },{ 0, 0, -12, 100,  46,   -8,   0, 0 },
//	{ 0, 0, -12,  92, 56, -10,   0, 0 },{ 0, 0, -12,  84,  66,  -12,   0, 0 },
//	{ 0, 0, -12,  76, 76, -12,   0, 0 },{ 0, 0, -12,  66,  84,  -12,   0, 0 },
//	{ 0, 0, -10,  56, 92, -12,   0, 0 },{ 0, 0, -8,  46,   100, -12,   0, 0 },
//	{ 0, 0,  -6,  36,108, -10,  0, 0 },{ 0, 0,  -6,  26,   114,  -8,   0, 0 },
//	{ 0, 0,  -4,  18,120,  -6,   0, 0 },{ 0, 0, -2,   8,   124,  -4,   0, 0 }
DECLARE_ALIGNED(256, static const InterpKernel,
...
#else
	if ((w <= 2 || h <= 2) && (interp_filter == MULTITAP_SHARP || interp_filter == EIGHTTAP_REGULAR))
		return av1_interp_4tap[0];
	else if ((w <= 2 || h <= 2) && interp_filter == EIGHTTAP_SMOOTH)
		return av1_interp_4tap[1];
	else if ((w <= 4 || h <= 4) && interp_filter == MULTITAP_SHARP)
